...
function card(x){
  ...
  return `<article class="card">
    ...
    <div class="body">${hero}
      ...
      <div class="sec"><b>Проверка HMS</b><p>${h(hs.label)} · проверено ${h(hs.verified||'—')}</p>${hasSds?`<p><a class="buy-btn" href="${h(sdsUrl)}" target="_blank" rel="noopener noreferrer">SDS / sikkerhetsdatablad ↗</a></p>`:'<p class="warn">SDS не привязан — STOP для профессионального использования.</p>'}</div>
