window.SIR_HSE_META={
  ...
  norway:{
    ...
    emergency:'Ved kjemikaliesprut i øyet: start skylling umiddelbart med rennende vann og hold øyelokkene åpne. Kontakt Giftinformasjonen 22 59 13 00 ved behov. Ved alvorlige symptomer: 113.',
    baselinePpe:'SIR-minimum ved dosering/sprøyting av konsentrert kjemi: kjemikaliebestandige hansker og tettsittende øyevern mot sprut. Dersom SDS avsnitt 8 krever mer, gjelder SDS.',
    storage:'Oppbevar kjemikalier i original eller korrekt norsk-merket beholder, lukket og utilgjengelig for uvedkommende. Ikke bruk mat-/drikkeflasker. Følg SDS avsnitt 7 for temperatur, ventilasjon og segregasjon.',
    sources:[
      'https://www.arbeidstilsynet.no/risikofylt-arbeid/kjemikalier/stoffkartotek/sikkerhetsdatablad/',
      'https://www.arbeidstilsynet.no/risikofylt-arbeid/kjemikalier/stoffkartotek/',
...
"Koch-Chemie Eulex, 1 л":{
  ...
  storage:"Hold beholderen tett lukket og adskilt fra tennkilder/varme i samsvar med SDS avsnitt 7.",
...
"Koch-Chemie Fleckenwasser, 1 л":{
  ...
  storage:"Tett lukket, kjølig/godt ventilert og vekk fra tennkilder. Avfall og søl håndteres etter SDS.",
...
"Koch-Chemie Fresh Up, 1 л":{
  ...
  storage:"Beskyttes mot frost og sterk varme; behold original merking og lukket beholder.",
...
"Koch-Chemie Glass Cleaner, 5 л":{
  ...
  storage:"Original/korrekt merket beholder, lukket. Følg SDS avsnitt 7.",
...
"Koch-Chemie Leather Star, 1 л":{
  ...
  storage:"Lukket originalbeholder og etter SDS avsnitt 7.",
...
"Koch-Chemie NanoMagicShampoo, 5 л":{
  ...
  storage:"Tett lukket, korrekt merket, etter SDS avsnitt 7.",
...
"Koch-Chemie Plast Star siliconölfrei, 1 л":{
  ...
  first:"Ved øyesprut: skyll umiddelbart. Følg SDS avsnitt 4.",
  storage:"Lukket beholder; følg SDS avsnitt 7.",
...
"Koch-Chemie Pol Star, 1 л":{
  ...
  storage:"Tett lukket og korrekt merket; følg SDS avsnitt 7.",
...
"Koch-Chemie Reactive Rust Remover, 500 мл":{
  ...
  first:"Ved øyesprut: skyll umiddelbart. Følg SDS avsnitt 4.",
  storage:"Original/korrekt merket beholder, lukket; etter SDS avsnitt 7.",
...
"Koch-Chemie Top Star, 1 л":{
  ...
  first:"Ved øyesprut: skyll straks. Følg SDS avsnitt 4.",
  storage:"Beskytt mot frost og sterk varme; lukket og merket beholder.",
...
"CARPRO DarkSide":{
  ...
  storage:"Oppbevares innelåst i henhold til norsk sikkerhetsinformasjon og utilgjengelig for barn/uvedkommende.",
...
"CARPRO Essence Plus":{
  ...
  storage:"Oppbevares innelåst og etter SDS avsnitt 7.",
...
"CARPRO ReTyre":{
  ...
  storage:"Oppbevares innelåst. Hold beholderen lukket og korrekt merket.",
...
"Autoglym Polar Blast":{
  ...
  storage:"Lukket originalbeholder; følg norsk SDS.",
  sds:"https://www.autoglym.com/no/pb002-5-polar-blast-nordno.html",verified:"2026-09-23"
},
"Gtechniq W4 Citrus Foam":{
  status:"STOP_NO_EXACT_SDS",label:"STOP: eksakt legacy-SDS mangler",level:"STOP",
  hazards:"Din flaske er en eldre rød W4-formulering. Etiketten og doseringen er identifisert, men et oppdatert norsk SDS for nøyaktig denne legacy-formuleringen er ikke verifisert. Nåværende W4-SDS kan gjelde en annen formulering.",
  ppe:"Ikke bruk i profesjonelt kundearbeid før SDS for nøyaktig legacy-produkt er hentet fra leverandør/Gtechniq og lagt i stoffkartoteket.",
  first:"Ved uhell: bruk etiketten som umiddelbar referanse, start øyeskylling ved sprut og kontakt Giftinformasjonen 22 59 13 00. Ved alvorlige symptomer 113.",
  storage:"Behold originalemballasjen og etiketten. Sett produktet i karantene/privat reserve til korrekt SDS er dokumentert.",
...
"Autoglym Polar Wash, 2,5 л":{
  ...
  storage:"Originalbeholder, lukket; følg norsk leverandør-SDS.",
...
"Turtle Wax Scratch Repair & Renew, 207 мл":{
  ...
  storage:"Lukket originalbeholder, utilgjengelig for barn/uvedkommende.",
  sds:"https://turtlewax.no/bilpleie-eksterior/turtle-wax-scratch-repair-renew/",verified:"2026-09-23"
},
"Kärcher FoamStop neutral":{
  status:"STOP_COMPATIBILITY",label:"STOP for Puzzi 8/1",level:"STOP",
  hazards:"Kärcher oppgir FoamStop neutral for vannfilter-/dampstøvsugere og dokumenterer ikke Puzzi 8/1 som kompatibel på produktsiden.",
  ppe:"Ikke doser i Puzzi 8/1 som standardprosedyre. Håndter og lagre etter leverandørens SDS/etikett.",
  first:"Ved eksponering: følg produktets SDS/etikett; ved øyesprut start umiddelbar skylling.",
  storage:"Originalbeholder, lukket og korrekt merket.",
  sds:"https://www.kaercher.com/int/home-garden/cleaning-and-care-agents/home-garden/vacuum-cleaner-with-water-filter-steam-vacuum-cleaner/foamstop/foamstop-neutral-62958730.html",verified:"2026-09-23"
}
};
