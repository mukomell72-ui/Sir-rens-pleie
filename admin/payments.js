(() => {
  ...
  const referralStatusLabel={pending:'Ожидает',earned:'Начислен',credited:'Зачислен',cancelled:'Отменён',rejected:'Отклонён'};
  ...
  function render(){
    ...
    root.innerHTML=`<div class="section-title"><div><h1>Оплаты и рекомендации</h1><p>Бонус начисляется рекомендателю только после статуса «Выполнен» + «Оплачено».</p></div><a class="btn" href="./">← Админка</a></div>
