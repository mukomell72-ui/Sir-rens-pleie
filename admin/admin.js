...
async function guide(){
  activeView='guide';
  main.innerHTML=`<div class="section-title"><div><h1>Справочник SIR</h1><p>Наш полный рабочий справочник теперь находится прямо в админке</p></div><div class="toolbar"><a class="btn" target="_blank" rel="noopener noreferrer" href="../guide-app/index-v13.html">Открыть отдельно</a><a class="btn" href="guide-editor.html?tool=dilution">Калькулятор разбавления</a><a class="btn primary" href="guide-editor.html">Редактировать знания</a></div></div><div class="guide-rules"><div><b>Один интерфейс</b><span>Полные карточки арсенала, цветовая маркировка и наличие показаны без упрощённой копии.</span></div><div><b>В конкретном заказе</b><span>Рабочая карта использует подтверждённые процедуры и химию из базы.</span></div><div><b>Безопасность</b><span>Неизвестный материал или несовместимость → spot-test либо STOP.</span></div></div><iframe class="guide-frame guide-frame-primary" src="../guide-app/index-v13.html?embedded=admin" scrolling="no" title="Справочник SIR: химия, оборудование и расходники"></iframe>`;
