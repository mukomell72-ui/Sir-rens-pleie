...
drop trigger if exists sir_guard_worker_order_update on public.orders;
create trigger sir_guard_worker_order_update before update on public.orders
for each row execute function private.guard_worker_order_update();
