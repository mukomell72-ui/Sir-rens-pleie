(()=>{
  ...
  const ruToNo=[
    ['химических/служебных карточек','kjemi-/systemkort'],['В справочнике:','I veiledningen:'],['Справочник использует отдельный слой безопасности для профессиональной работы в Норвегии.','Veiledningen bruker et eget sikkerhetslag for profesjonelt arbeid i Norge.'],['SDS и этикетка производителя всегда имеют приоритет.','SDS og produsentetiketten har alltid prioritet.'],['Новая или изменённая химия без проверенной HMS-записи автоматически получает','Ny eller endret kjemi uten kontrollert HMS-oppføring får automatisk'],['Внутренняя политика SIR: каждая HMS/SDS-запись перепроверяется минимум раз в 365 дней и раньше при смене формулы, этикетки или документации.','Intern SIR-policy: hver HMS/SDS-oppføring kontrolleres minst hver 365. dag og tidligere ved endring av formel, etikett eller dokumentasjon.'],['при попадании химии начать промывание немедленно проточной водой, удерживая веки открытыми. Не откладывать промывание ради звонка.','Ved kjemikaliesprut, start umiddelbart skylling med rennende vann mens øyelokkene holdes åpne. Ikke utsett skylling for å ringe.'],['круглосуточно','døgnåpent'],['мл','ml'],['л','l'],['В СПРАВОЧНИКЕ:','I VEILEDNINGEN:'],['химия','kjemiprodukter'],['РАСХОДНИКИ','FORBRUKSVARER'],['оранжевый','oransje'],['розовый','rosa'],['серебристый','sølv'],['жёлто-зелёный','gulgrønn'],['бирюзовый','turkis'],['жёлтый','gul'],['салатовый','limegrønn'],['красный','rød'],['фиолетовый','lilla'],['жёлто-серый','gulgrå'],['бело-синий','hvit/blå'],['белый/жёлтый','hvit/gul'],['голубой','lyseblå'],['зелёный','grønn'],['HMS слой','HMS-lag'],['следующая обязательная перепроверка не позднее','neste obligatoriske kontroll senest'],['HMS готовы','HMS klare'],['позиций','elementer'],['Центр контроля','Kontrollsenter'],['Под контролем','Under kontroll'],['Требует внимания','Krever oppmerksomhet'],['Срочных действий нет','Ingen hastetiltak'],
