(()=>{
  ...
  const ruToNo=[
    ['химических/служебных карточек','kjemi-/systemkort'],['HMS слой','HMS-lag'],['следующая обязательная перепроверка не позднее','neste obligatoriske kontroll senest'],['HMS готовы','HMS klare'],['позиций','elementer'],['Центр контроля','Kontrollsenter'],['Под контролем','Under kontroll'],['Требует внимания','Krever oppmerksomhet'],['Срочных действий нет','Ingen hastetiltak'],
