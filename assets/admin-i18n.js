(()=>{
  ...
  const rows=[
    ...
    ['E-post','Эл. почта'],['Passord','Пароль'],['Logg inn','Войти'],['Glemt passord?','Забыли пароль?'],['Logg inn i SIR Admin først.','Сначала войдите в SIR Admin.'],['Åpne sikker forhåndsvisning','Открыть безопасный предпросмотр'],
